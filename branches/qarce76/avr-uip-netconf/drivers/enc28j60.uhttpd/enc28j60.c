...
uint8_t enc28j60ReadOp(uint8_t op, uint8_t address)
{
	...
	// assert CS
	ENC28J60_CONTROL_PORT &= ~(1<<ENC28J60_SPI_SS);
...
void enc28j60Init(uint8_t DuplexState)
{
//	uint8_t i,j;
	// initialize I/O
	sbi(ENC28J60_CONTROL_DDR,  ENC28J60_SPI_SS);
	sbi(ENC28J60_CONTROL_PORT, ENC28J60_SPI_SS);
  ...
  cbi(ENC28J60_CONTROL_DDR,  ENC28J60_INT_PIN);
	...
	// setup SPI I/O pins
	sbi(PORTB, ENC28J60_SPI_SCK);	// set SCK hi
	...
	sbi(ENC28J60_CONTROL_DDR, ENC28J60_SPI_SS);	  // SS must be output for Master mode to work
